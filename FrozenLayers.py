from transformers import AutoImageProcessor, ResNetForImageClassification, TrainingArguments, Trainer, get_scheduler
...
with open("trainer_output/frozen_history.json", "w") as f:
